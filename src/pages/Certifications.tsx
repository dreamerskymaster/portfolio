...
const Certifications: React.FC = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Professional Certifications | Ajith Srikanth</title>
        <meta name="description" content="View certificates and specializations in Six Sigma, Lean Manufacturing, Project Management, and Intelligent Automation. Certified excellence in industrial engineering." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
              ...
              <div className="bg-card border border-border rounded-xl p-6 text-center">
                <div className="text-3xl font-bold text-accent-2 mb-2">{categories.length - 1}</div>
            ...
            {Object.entries(certificationData).map(([category, certs], index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`cursor-pointer border rounded-xl p-6 text-center hover:shadow-lg transition-all ${selectedCategory === category ? getCategoryColor(category) : 'bg-card border-border hover:bg-muted'
                    }`}
                >
