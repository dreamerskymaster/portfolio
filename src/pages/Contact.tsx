...
const Contact: React.FC = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Contact Ajith Srikanth | Collaborative Engineering</title>
        <meta name="description" content="Get in touch with Ajith Srikanth for collaborations in manufacturing engineering, AI implementation, or professional consulting." />
      </Helmet>
                  ...
                  <div className="lg:w-1/3">
                    <div className="space-y-3">
                      {featuredTestimonials.map((testimonial, index) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold ${activeTestimonial === index ? 'bg-primary' : 'bg-muted-foreground'
                              }`}>
                              {testimonial.avatar}
                            </div>
                            <div>
