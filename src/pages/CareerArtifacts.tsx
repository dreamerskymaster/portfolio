...
const CareerArtifacts: React.FC = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Career Artifacts & Documentation | Ajith Srikanth</title>
        <meta name="description" content="Access professional reports, experience letters, and technical documentation from my career in manufacturing and automation engineering." />
      </Helmet>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          {doc.highlights.length > 3 && (
                            <Chip variant="muted" size="sm" className="mb-1">
                  ...
                  <div className="h-[70vh] border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                    {selectedDocument.filePath.endsWith('.pdf') ? (
                      <div className="relative w-full h-full">
                        {/* Overlay to prevent direct interaction with iframe controls if possible */}
